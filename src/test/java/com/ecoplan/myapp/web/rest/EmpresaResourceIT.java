...
import com.ecoplan.myapp.repository.EmpresaRepository;
...
public class EmpresaResourceIT {
    ...
    public void createEmpresa() throws Exception {
        ...
        // Create the Empresa
        restEmpresaMockMvc
            .perform(post("/api/empresas").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(empresa)))
    ...
    public void getAllEmpresas() throws Exception {
        ...
        restEmpresaMockMvc
            .perform(get("/api/empresas?sort=id,desc"))
    ...
    public void getEmpresa() throws Exception {
        ...
        // Get the empresa
        restEmpresaMockMvc
            .perform(get("/api/empresas/{id}", empresa.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingEmpresa() throws Exception {
        // Get the empresa
        restEmpresaMockMvc.perform(get("/api/empresas/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateEmpresa() throws Exception {
        ...
        restEmpresaMockMvc
            .perform(
                put("/api/empresas").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedEmpresa))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingEmpresa() throws Exception {
        ...
        restEmpresaMockMvc
            .perform(put("/api/empresas").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(empresa)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteEmpresa() throws Exception {
        ...
        // Delete the empresa
        restEmpresaMockMvc
            .perform(delete("/api/empresas/{id}", empresa.getId()).accept(MediaType.APPLICATION_JSON))
