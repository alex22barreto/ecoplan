...
public class ActividadResourceIT {
    ...
    public void createActividad() throws Exception {
        ...
        restActividadMockMvc
            .perform(post("/api/actividads").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(actividad)))
    ...
    public void getAllActividads() throws Exception {
        ...
        restActividadMockMvc
            .perform(get("/api/actividads?sort=id,desc"))
    ...
    public void getActividad() throws Exception {
        ...
        // Get the actividad
        restActividadMockMvc
            .perform(get("/api/actividads/{id}", actividad.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingActividad() throws Exception {
        // Get the actividad
        restActividadMockMvc.perform(get("/api/actividads/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateActividad() throws Exception {
        ...
        restActividadMockMvc
            .perform(
                put("/api/actividads").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedActividad))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingActividad() throws Exception {
        ...
        restActividadMockMvc
            .perform(put("/api/actividads").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(actividad)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteActividad() throws Exception {
        ...
        restActividadMockMvc
            .perform(delete("/api/actividads/{id}", actividad.getId()).accept(MediaType.APPLICATION_JSON))
