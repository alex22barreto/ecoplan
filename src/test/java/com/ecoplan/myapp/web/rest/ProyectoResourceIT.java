...
import com.ecoplan.myapp.PilotoEcoPlanApp;
import com.ecoplan.myapp.domain.Proyecto;
import com.ecoplan.myapp.repository.ProyectoRepository;
 ...
 */
@SpringBootTest(classes = PilotoEcoPlanApp.class)
...
public class ProyectoResourceIT {
    ...
    public static Proyecto createEntity(EntityManager em) {
        Proyecto proyecto = new Proyecto().codigoProyecto(DEFAULT_CODIGO_PROYECTO).nombre(DEFAULT_NOMBRE);
        return proyecto;
    }
    ...
    public static Proyecto createUpdatedEntity(EntityManager em) {
        Proyecto proyecto = new Proyecto().codigoProyecto(UPDATED_CODIGO_PROYECTO).nombre(UPDATED_NOMBRE);
        return proyecto;
    }
    ...
    public void createProyecto() throws Exception {
        ...
        // Create the Proyecto
        restProyectoMockMvc
            .perform(post("/api/proyectos").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(proyecto)))
    ...
    public void getAllProyectos() throws Exception {
        ...
        restProyectoMockMvc
            .perform(get("/api/proyectos?sort=id,desc"))
    ...
    public void getProyecto() throws Exception {
        ...
        // Get the proyecto
        restProyectoMockMvc
            .perform(get("/api/proyectos/{id}", proyecto.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingProyecto() throws Exception {
        // Get the proyecto
        restProyectoMockMvc.perform(get("/api/proyectos/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateProyecto() throws Exception {
        ...
        updatedProyecto.codigoProyecto(UPDATED_CODIGO_PROYECTO).nombre(UPDATED_NOMBRE);

        restProyectoMockMvc
            .perform(
                put("/api/proyectos").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedProyecto))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingProyecto() throws Exception {
        ...
        restProyectoMockMvc
            .perform(put("/api/proyectos").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(proyecto)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteProyecto() throws Exception {
        ...
        // Delete the proyecto
        restProyectoMockMvc
            .perform(delete("/api/proyectos/{id}", proyecto.getId()).accept(MediaType.APPLICATION_JSON))
