...
import com.ecoplan.myapp.repository.EstadoRepository;
...
public class EstadoResourceIT {
    ...
    public static Estado createEntity(EntityManager em) {
        Estado estado = new Estado().estadoNombre(DEFAULT_ESTADO_NOMBRE);
        return estado;
    }
    ...
    public static Estado createUpdatedEntity(EntityManager em) {
        Estado estado = new Estado().estadoNombre(UPDATED_ESTADO_NOMBRE);
        return estado;
    }
    ...
    public void createEstado() throws Exception {
        ...
        // Create the Estado
        restEstadoMockMvc
            .perform(post("/api/estados").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(estado)))
    ...
    public void getAllEstados() throws Exception {
        ...
        restEstadoMockMvc
            .perform(get("/api/estados?sort=id,desc"))
    ...
    public void getEstado() throws Exception {
        ...
        // Get the estado
        restEstadoMockMvc
            .perform(get("/api/estados/{id}", estado.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingEstado() throws Exception {
        // Get the estado
        restEstadoMockMvc.perform(get("/api/estados/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateEstado() throws Exception {
        ...
        updatedEstado.estadoNombre(UPDATED_ESTADO_NOMBRE);

        restEstadoMockMvc
            .perform(put("/api/estados").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedEstado)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingEstado() throws Exception {
        ...
        restEstadoMockMvc
            .perform(put("/api/estados").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(estado)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteEstado() throws Exception {
        ...
        // Delete the estado
        restEstadoMockMvc
            .perform(delete("/api/estados/{id}", estado.getId()).accept(MediaType.APPLICATION_JSON))
