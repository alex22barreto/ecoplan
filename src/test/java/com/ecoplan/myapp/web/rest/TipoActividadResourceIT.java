...
import com.ecoplan.myapp.repository.TipoActividadRepository;
...
public class TipoActividadResourceIT {
    ...
    public static TipoActividad createEntity(EntityManager em) {
        TipoActividad tipoActividad = new TipoActividad().nombreTipoActividad(DEFAULT_NOMBRE_TIPO_ACTIVIDAD);
    ...
    public static TipoActividad createUpdatedEntity(EntityManager em) {
        TipoActividad tipoActividad = new TipoActividad().nombreTipoActividad(UPDATED_NOMBRE_TIPO_ACTIVIDAD);
        return tipoActividad;
    }
    ...
    public void createTipoActividad() throws Exception {
        ...
        restTipoActividadMockMvc
            .perform(
                post("/api/tipo-actividads")
    ...
    public void getAllTipoActividads() throws Exception {
        ...
        restTipoActividadMockMvc
            .perform(get("/api/tipo-actividads?sort=id,desc"))
    ...
    public void getTipoActividad() throws Exception {
        ...
        restTipoActividadMockMvc
            .perform(get("/api/tipo-actividads/{id}", tipoActividad.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingTipoActividad() throws Exception {
        // Get the tipoActividad
        restTipoActividadMockMvc.perform(get("/api/tipo-actividads/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateTipoActividad() throws Exception {
        ...
        updatedTipoActividad.nombreTipoActividad(UPDATED_NOMBRE_TIPO_ACTIVIDAD);

        restTipoActividadMockMvc
            .perform(
                put("/api/tipo-actividads")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTipoActividad() throws Exception {
        ...
        restTipoActividadMockMvc
            .perform(delete("/api/tipo-actividads/{id}", tipoActividad.getId()).accept(MediaType.APPLICATION_JSON))
