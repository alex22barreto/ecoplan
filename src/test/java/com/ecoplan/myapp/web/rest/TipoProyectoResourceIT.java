...
import com.ecoplan.myapp.repository.TipoProyectoRepository;
...
public class TipoProyectoResourceIT {
    ...
    public static TipoProyecto createEntity(EntityManager em) {
        TipoProyecto tipoProyecto = new TipoProyecto().nombreTipoProyecto(DEFAULT_NOMBRE_TIPO_PROYECTO);
        return tipoProyecto;
    }
    ...
    public static TipoProyecto createUpdatedEntity(EntityManager em) {
        TipoProyecto tipoProyecto = new TipoProyecto().nombreTipoProyecto(UPDATED_NOMBRE_TIPO_PROYECTO);
        return tipoProyecto;
    }
    ...
    public void createTipoProyecto() throws Exception {
        ...
        restTipoProyectoMockMvc
            .perform(
                post("/api/tipo-proyectos").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tipoProyecto))
            )
    ...
    public void getAllTipoProyectos() throws Exception {
        ...
        restTipoProyectoMockMvc
            .perform(get("/api/tipo-proyectos?sort=id,desc"))
    ...
    public void getTipoProyecto() throws Exception {
        ...
        restTipoProyectoMockMvc
            .perform(get("/api/tipo-proyectos/{id}", tipoProyecto.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingTipoProyecto() throws Exception {
        // Get the tipoProyecto
        restTipoProyectoMockMvc.perform(get("/api/tipo-proyectos/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateTipoProyecto() throws Exception {
        ...
        updatedTipoProyecto.nombreTipoProyecto(UPDATED_NOMBRE_TIPO_PROYECTO);

        restTipoProyectoMockMvc
            .perform(
                put("/api/tipo-proyectos")
    ...
    public void updateNonExistingTipoProyecto() throws Exception {
        ...
        restTipoProyectoMockMvc
            .perform(
                put("/api/tipo-proyectos").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tipoProyecto))
            )
            .andExpect(status().isBadRequest());
    ...
    public void deleteTipoProyecto() throws Exception {
        ...
        restTipoProyectoMockMvc
            .perform(delete("/api/tipo-proyectos/{id}", tipoProyecto.getId()).accept(MediaType.APPLICATION_JSON))
