...
describe('Estado e2e test', () => {
  ...
  it('should load Estados', async () => {
    ...
    expect(await estadoComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.estado.home.title');
  ...
  it('should load create Estado page', async () => {
    ...
    expect(await estadoUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.estado.home.createOrEditLabel');
  ...
  it('should delete last Estado', async () => {
    ...
    expect(await estadoDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.estado.delete.question');
