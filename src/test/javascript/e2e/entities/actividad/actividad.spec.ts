...
describe('Actividad e2e test', () => {
  ...
  it('should load Actividads', async () => {
    ...
    expect(await actividadComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.actividad.home.title');
  ...
  it('should load create Actividad page', async () => {
    ...
    expect(await actividadUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.actividad.home.createOrEditLabel');
  ...
  it('should delete last Actividad', async () => {
    ...
    expect(await actividadDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.actividad.delete.question');
