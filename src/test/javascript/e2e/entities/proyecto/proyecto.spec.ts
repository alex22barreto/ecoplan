...
describe('Proyecto e2e test', () => {
  ...
  it('should load Proyectos', async () => {
    ...
    expect(await proyectoComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.proyecto.home.title');
  ...
  it('should load create Proyecto page', async () => {
    ...
    expect(await proyectoUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.proyecto.home.createOrEditLabel');
  ...
  it('should delete last Proyecto', async () => {
    ...
    expect(await proyectoDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.proyecto.delete.question');
