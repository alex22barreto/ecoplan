...
describe('TipoActividad e2e test', () => {
  ...
  it('should load TipoActividads', async () => {
    ...
    expect(await tipoActividadComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.tipoActividad.home.title');
    await browser.wait(
  ...
  it('should load create TipoActividad page', async () => {
    ...
    expect(await tipoActividadUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.tipoActividad.home.createOrEditLabel');
  ...
  it('should delete last TipoActividad', async () => {
    ...
    expect(await tipoActividadDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.tipoActividad.delete.question');
