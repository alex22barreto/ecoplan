...
describe('TipoProyecto e2e test', () => {
  ...
  it('should load TipoProyectos', async () => {
    ...
    expect(await tipoProyectoComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.tipoProyecto.home.title');
    await browser.wait(
  ...
  it('should load create TipoProyecto page', async () => {
    ...
    expect(await tipoProyectoUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.tipoProyecto.home.createOrEditLabel');
  ...
  it('should delete last TipoProyecto', async () => {
    ...
    expect(await tipoProyectoDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.tipoProyecto.delete.question');
