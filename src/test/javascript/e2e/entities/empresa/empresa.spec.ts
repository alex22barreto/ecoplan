...
describe('Empresa e2e test', () => {
  ...
  it('should load Empresas', async () => {
    ...
    expect(await empresaComponentsPage.getTitle()).to.eq('pilotoEcoPlanApp.empresa.home.title');
  ...
  it('should load create Empresa page', async () => {
    ...
    expect(await empresaUpdatePage.getPageTitle()).to.eq('pilotoEcoPlanApp.empresa.home.createOrEditLabel');
  ...
  it('should delete last Empresa', async () => {
    ...
    expect(await empresaDeleteDialog.getDialogTitle()).to.eq('pilotoEcoPlanApp.empresa.delete.question');
