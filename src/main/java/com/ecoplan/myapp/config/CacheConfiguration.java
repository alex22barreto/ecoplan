package com.ecoplan.myapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ecoplan.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ecoplan.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
